...
parameter_types! {
	...
	pub const LegendaryOriginOfShellPrice: Balance = 10_000 * DOLLARS;
	pub const MagicOriginOfShellPrice: Balance = 1_000 * DOLLARS;
	pub const HeroOriginOfShellPrice: Balance = 100 * DOLLARS;
